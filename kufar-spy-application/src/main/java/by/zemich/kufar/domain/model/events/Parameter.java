...
public class Parameter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static by.zemich.kufar.domain.model.events.Parameter.Builder newBuilder() {
    return new by.zemich.kufar.domain.model.events.Parameter.Builder();
  }
   ...
   * @return A new Parameter RecordBuilder
   */
  public static by.zemich.kufar.domain.model.events.Parameter.Builder newBuilder(by.zemich.kufar.domain.model.events.Parameter.Builder other) {
    if (other == null) {
      return new by.zemich.kufar.domain.model.events.Parameter.Builder();
    } else {
      return new by.zemich.kufar.domain.model.events.Parameter.Builder(other);
    }
  }
   ...
   * @return A new Parameter RecordBuilder
   */
  public static by.zemich.kufar.domain.model.events.Parameter.Builder newBuilder(by.zemich.kufar.domain.model.events.Parameter other) {
    if (other == null) {
      return new by.zemich.kufar.domain.model.events.Parameter.Builder();
    } else {
      return new by.zemich.kufar.domain.model.events.Parameter.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Parameter>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(by.zemich.kufar.domain.model.events.Parameter.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(by.zemich.kufar.domain.model.events.Parameter other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.identity)) {
        this.identity = data().deepCopy(fields()[0].schema(), other.identity);
    ...
    /**
      ...
      * @return This builder.
      */
    public by.zemich.kufar.domain.model.events.Parameter.Builder setIdentity(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public by.zemich.kufar.domain.model.events.Parameter.Builder clearIdentity() {
      identity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public by.zemich.kufar.domain.model.events.Parameter.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public by.zemich.kufar.domain.model.events.Parameter.Builder clearValue() {
      value = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public by.zemich.kufar.domain.model.events.Parameter.Builder setLabel(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public by.zemich.kufar.domain.model.events.Parameter.Builder clearLabel() {
      label = null;
